...
const COLORS = ['#f97316', '#14b8a6', '#f59e0b', '#ef4444', '#f97316', '#ec4899', '#06b6d4']
...
export function AnalyticsDashboard() {
  ...
  const summaryCards = summary ? [
    { label: 'Total Views', value: summary.totalViews.toLocaleString(), icon: Eye, color: 'text-rose-600', gradient: 'bg-gradient-to-br from-rose-400 via-rose-500 to-rose-600 text-white shadow-lg shadow-rose-500/30 ring-1 ring-white/10' },
    { label: 'Total Likes', value: summary.totalLikes.toLocaleString(), icon: Heart, color: 'text-pink-600', gradient: 'bg-gradient-to-br from-pink-400 via-rose-500 to-rose-600 text-white shadow-lg shadow-pink-500/30 ring-1 ring-white/10' },
    { label: 'Total Shares', value: summary.totalShares.toLocaleString(), icon: Share2, color: 'text-rose-600', gradient: 'bg-gradient-to-br from-rose-400 via-cyan-500 to-rose-600 text-white shadow-lg shadow-rose-500/30 ring-1 ring-white/10' },
    { label: 'Total Komentar', value: summary.totalComments.toLocaleString(), icon: MessageCircle, color: 'text-amber-600', gradient: 'bg-gradient-to-br from-amber-400 via-rose-500 to-red-500 text-white shadow-lg shadow-amber-500/30 ring-1 ring-white/10' },
    { label: 'Total Klik', value: summary.totalClicks.toLocaleString(), icon: MousePointerClick, color: 'text-rose-600', gradient: 'bg-gradient-to-br from-rose-400 via-purple-500 to-indigo-600 text-white shadow-lg shadow-rose-500/30 ring-1 ring-white/10' },
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            ...
            <Button size="sm" onClick={handleSeedDemo} className="bg-rose-600 hover:bg-rose-700 text-white gap-1.5">
      ...
      {isLoading ? (
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          <Card className="border-dashed border-2 border-muted-foreground/25">
            <CardContent className="p-10 flex flex-col items-center justify-center text-center">
              ...
              <div className="flex gap-2">
                <Button onClick={handleSeedDemo} className="bg-rose-600 hover:bg-rose-700 text-white gap-2">
        ...
        <>
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.5 }}>
            <Card className="border-rose-200/50 dark:border-orange-900/50">
              <CardHeader className="pb-2">
                <CardTitle className="text-sm text-rose-700 dark:text-rose-400">Top 10 Konten Terbaik</CardTitle>
              </CardHeader>
              <CardContent>

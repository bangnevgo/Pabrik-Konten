...
export const iconPresets = {
  blog: {
    icon: BookOpen,
    gradient: 'bg-gradient-to-br from-rose-400 via-rose-500 to-purple-600 text-white shadow-lg shadow-rose-500/30 ring-1 ring-white/10',
    light: 'bg-orange-50/80 text-rose-600 ring-1 ring-rose-200/60 dark:bg-orange-900/30 dark:text-orange-400 dark:ring-orange-700/40',
    glow: 'shadow-rose-500/40',
  },
  social: {
    icon: Smartphone,
    gradient: 'bg-gradient-to-br from-amber-400 via-rose-500 to-rose-600 text-white shadow-lg shadow-rose-500/30 ring-1 ring-white/10',
  ...
  marketing: {
    icon: Megaphone,
    gradient: 'bg-gradient-to-br from-red-400 via-rose-500 to-rose-500 text-white shadow-lg shadow-red-500/30 ring-1 ring-white/10',
    light: 'bg-red-50/80 text-red-600 ring-1 ring-red-200/60 dark:bg-red-900/30 dark:text-red-400 dark:ring-red-700/40',
    glow: 'shadow-red-500/40',
  },
  email: {
    icon: Mail,
    gradient: 'bg-gradient-to-br from-sky-400 via-blue-500 to-indigo-500 text-white shadow-lg shadow-sky-500/30 ring-1 ring-white/10',
    light: 'bg-sky-50/80 text-sky-600 ring-1 ring-sky-200/60 dark:bg-sky-900/30 dark:text-sky-400 dark:ring-sky-700/40',
    glow: 'shadow-sky-500/40',
  },
  product: {
    icon: ShoppingBag,
    gradient: 'bg-gradient-to-br from-amber-400 via-rose-500 to-yellow-600 text-white shadow-lg shadow-amber-500/30 ring-1 ring-white/10',
    light: 'bg-amber-50/80 text-amber-600 ring-1 ring-amber-200/60 dark:bg-amber-900/30 dark:text-amber-400 dark:ring-amber-700/40',
    glow: 'shadow-amber-500/40',
  },
  video: {
    icon: Clapperboard,
    gradient: 'bg-gradient-to-br from-rose-400 via-pink-500 to-rose-600 text-white shadow-lg shadow-rose-500/30 ring-1 ring-white/10',
  ...
  batch: {
    icon: Layers,
    gradient: 'bg-gradient-to-br from-cyan-400 via-sky-500 to-blue-500 text-white shadow-lg shadow-cyan-500/30 ring-1 ring-white/10',
  ...
  templates: {
    icon: LayoutTemplate,
    gradient: 'bg-gradient-to-br from-indigo-400 via-blue-500 to-sky-500 text-white shadow-lg shadow-indigo-500/30 ring-1 ring-white/10',
  ...
  library: {
    icon: Library,
    gradient: 'bg-gradient-to-br from-rose-400 via-rose-500 to-pink-600 text-white shadow-lg shadow-rose-500/30 ring-1 ring-white/10',
    light: 'bg-orange-50/80 text-rose-600 ring-1 ring-rose-200/60 dark:bg-orange-900/30 dark:text-orange-400 dark:ring-orange-700/40',
    glow: 'shadow-rose-500/40',
  },
  calendar: {
    icon: CalendarDays,
    gradient: 'bg-gradient-to-br from-blue-400 via-indigo-500 to-purple-500 text-white shadow-lg shadow-blue-500/30 ring-1 ring-white/10',
  ...
  analytics: {
    icon: TrendingUp,
    gradient: 'bg-gradient-to-br from-rose-400 via-rose-500 to-amber-500 text-white shadow-lg shadow-rose-500/30 ring-1 ring-white/10',
    light: 'bg-rose-50/80 text-rose-600 ring-1 ring-rose-200/60 dark:bg-rose-900/30 dark:text-rose-400 dark:ring-rose-700/40',
    glow: 'shadow-rose-500/40',
  },
  create: {
  ...
  lightbulb: {
    icon: Lightbulb,
    gradient: 'bg-gradient-to-br from-yellow-300 via-amber-400 to-rose-500 text-white shadow-lg shadow-amber-400/30 ring-1 ring-white/10',
    light: 'bg-amber-50/80 text-amber-600 ring-1 ring-amber-200/60 dark:bg-amber-900/30 dark:text-amber-400 dark:ring-amber-700/40',
  ...
  sparkles: {
    icon: Sparkles,
    gradient: 'bg-gradient-to-br from-amber-300 via-yellow-400 to-rose-500 text-white shadow-lg shadow-yellow-400/30 ring-1 ring-white/10',
  ...
  target: {
    icon: Target,
    gradient: 'bg-gradient-to-br from-red-400 via-rose-500 to-amber-600 text-white shadow-lg shadow-red-400/30 ring-1 ring-white/10',
    light: 'bg-red-50/80 text-red-600 ring-1 ring-red-200/60 dark:bg-red-900/30 dark:text-red-400 dark:ring-red-700/40',
    glow: 'shadow-red-400/40',
  },
  share: {
    icon: Share2,
    gradient: 'bg-gradient-to-br from-indigo-400 via-purple-500 to-rose-600 text-white shadow-lg shadow-indigo-500/30 ring-1 ring-white/10',
    light: 'bg-indigo-50/80 text-indigo-600 ring-1 ring-indigo-200/60 dark:bg-indigo-900/30 dark:text-indigo-400 dark:ring-indigo-700/40',
    glow: 'shadow-indigo-500/40',
  },
  pen: {

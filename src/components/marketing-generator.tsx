        ...
        <Card className="border-violet-200/50 dark:border-violet-900/50">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="marketing-topic">Produk / Layanan / Topik</Label>
              <Textarea
                id="marketing-topic"
                placeholder="Contoh: Aplikasi manajemen keuangan pribadi dengan fitur AI"
                value={prompt}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="marketing-audience">Target Audiens</Label>
                <Input
                  id="marketing-audience"
                  placeholder="Contoh: pekerja kantoran, UMKM"
                  value={targetAudience}
                  onChange={(e) => setTargetAudience(e.target.value)}
                />
              </div>
              <div className="space-y-2">
                <Label>Panjang Copy</Label>
